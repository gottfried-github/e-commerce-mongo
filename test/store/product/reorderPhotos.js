    ...
    describe("reorderPhotos", () => {
        ...
        describe("passed updated order of all existing photos", () => {
            it("updates the photos", async () => {
                ...
                const photo0 = photosDocs[
                    photosDocs
                        .map(photo => photo._id.toString())
                        .indexOf(photosIds[0].toString())
                ]

                const photo1 = photosDocs[
                    photosDocs
                        .map(photo => photo._id.toString())
                        .indexOf(photosIds[1].toString())
                ]

                const photo2 = photosDocs[
                    photosDocs
                        .map(photo => photo._id.toString())
                        .indexOf(photosIds[2].toString())
                ]
